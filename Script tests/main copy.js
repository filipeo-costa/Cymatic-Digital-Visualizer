...
const colorPresets = {
  White:{r:1,g:1,b:1},
  Neon:{r:0.3,g:1,b:0.8},
  Sunset:{r:1,g:0.4,b:0.3},
  Magenta:{r:1,g:0.1,b:0.9}
};
...
// Geometry, Display Mode, Color Theme, Waveform GUI
...
gui.add(params,'colorTheme', Object.keys(colorPresets)).name('Color Theme').onChange(name=>{
  ...
  uniforms.u_red.value=c.r; uniforms.u_green.value=c.g; uniforms.u_blue.value=c.b;
  params.red=c.r; params.green=c.g; params.blue=c.b;
